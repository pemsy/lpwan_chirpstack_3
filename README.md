...
```
create role chirpstack_as with login password 'A5CeMNZJTNCv2kiSt4rX';
create role chirpstack_ns with login password '3ZTkyfMTgjwFJLKsUwKu';
```
...
dsn="postgres://chirpstack_ns:3ZTkyfMTgjwFJLKsUwKu@localhost/chirpstack_ns?sslmode=disable"
...
```
lC6dGo7W2WYZ+CNAkQ5clq0+WkPx4SNJy87SehUYH8g=
```
...
# * verify-ca - Always SSL (verify that the certificate presented by the server was signed by a trusted CA)
# * verify-full - Always SSL (verify that the certification presented by the server was signed by a trusted CA and the server host name matches the one in the certificate)
dsn="postgres://chirpstack_as:A5CeMNZJTNCv2kiSt4rX@localhost/chirpstack_as?sslmode=disable"
...
id="6d5db27e-4ce2-4b2b-b5d7-91f069397978"
  ...
  jwt_secret="lC6dGo7W2WYZ+CNAkQ5clq0+WkPx4SNJy87SehUYH8g="
